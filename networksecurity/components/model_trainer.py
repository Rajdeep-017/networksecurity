...
from networksecurity.utils.main_utils.utils import load_numpy_arr_data,save_object,load_object,evaluate_models
...
class Modeltrainer:
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        ...
        classfication_train_metric=get_classifaction_score(y_true=y_train,y_pred=y_train_pred)
        #track mlflow experiment
        self.track_mlflow(best_model,classfication_train_metric)


        y_test_pred=best_model.predict(x_test)
        classfication_test_metric=get_classifaction_score(y_true=y_test,y_pred=y_test_pred)
    ...
    def initiate_model_trainer(self)->Modeltrainerartifact:
        try:
            train_file_path=self.data_transformation_artifact.transfromed_train_file_path
